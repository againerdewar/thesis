...
TODO: Discuss calculation of generating functions from cycle index.
...
\begin{proof}
  ...
  As we have noted, the $X$-label on the root black vertex is unaffected by the action of every $\sigma$, so there must be a $p_{1} \sbrac{x}$ factor in the result.
