...
\begin{theorem}
  ...
  \begin{subequations}
    ...
    \end{align}
  \end{subequations}
  as identities of ordinary species.
\end{theorem}
...
As noted previously, there does exist a (unique) choice of orientation for each descendant which restores orientation coherency.
TODO: reference to where this was said?
...
\begin{theorem}
  ...
  \begin{subequations}
    ...
    \end{align}
  \end{subequations}
where $\pointed[\overline{XY}]{\specname{CT}}_{k}$ is an $\symgp{k}$-species in \eqref{eq:axyquot} and an $\symgp{k+1}$-species in \eqref{eq:axquot}.
\end{theorem}
...
\begin{theorem}
  ...
  \begin{align}
    \widetilde{\pointed[Y]{\specname{CT}}_{k}} \pbrac{\sigma} \pbrac{x} &= E \pbrac{x \cdot \prod_{c \in C \pbrac{\sigma}} \widetilde{\pointed[Y]{\specname{CT}}_{k}}_{\prod_{i \in c} \rho_{i} \pbrac{\sigma}} \pbrac{x^{\abs{c}}}} \label{eq:ctyogf} \\
    \widetilde{\pointed[\overline{XY}]{\specname{CT}}_{k}} \pbrac{\sigma} \pbrac{x} &= x \cdot \prod_{c \in C \pbrac{\sigma}} \widetilde{\pointed[Y]{\specname{CT}}_{k}}_{\prod_{i \in c} \rho_{i} \pbrac{\sigma}} \pbrac{x^{\abs{c}}} \label{eq:ctxyogf}
  \end{align}
\end{theorem}
