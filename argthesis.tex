...
\begin{figure}[htb]
  ...
  \end{tikzpicture}
  \caption[An example $\overline{XY}$-rooted $k$-coding tree]{An example $\pointed[\overline{XY}]{\specname{CT}}_{\kval}$-structure, rooted at the $X$-vertex and the dashed edge adjoining it.}
  \label{fig:ctxyconst}
\end{figure}
