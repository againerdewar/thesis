...
Since we are concerned at this stage only with the fronts and hedra of coherently-oriented $k$-trees, it is convenient to encode them in a surrogate structure which exposes those features more clearly.
We will use for this purpose structured bicolored trees in the spirit of the $R, S$-enriched bicolored trees of \cite[\S 3.2]{bll:species}.
