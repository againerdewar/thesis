...
\begin{theorem}
  ...
  \begin{subequations}
    \label{eq:ctrhoogf}
    \begin{align}
      \widetilde{\cty{k}} \pbrac{\sigma} \pbrac{x} &= \exp \pbrac{ \sum_{n \geq 1} \frac{x^{n}}{n} \cdot \prod_{c \in C \pbrac{\sigma^{n}}} \widetilde{\cty{k}} \pbrac{\Delta^{-1} \prod_{i \in c} \rho_{i} \pbrac{\Delta \sigma^{n}}} \pbrac{x^{\abs{c}}}} \label{eq:ctyrhoogf} \\
      \intertext{and}
      \widetilde{\ctxy{k}} \pbrac{\sigma} \pbrac{x} &= x \cdot \prod_{c \in C \pbrac{\sigma}} \widetilde{\cty{k}} \pbrac{\prod_{i \in c} \rho_{i} \pbrac{\sigma}} \pbrac{x^{\abs{c}}}. \label{eq:ctxyrhoogf}
    \end{align}
  \end{subequations}
...
\begin{corollary}
  ...
  \begin{subequations}
    \label{eq:ctogf}
    \begin{align}
      \widetilde{\cty{k}} \pbrac{\lambda} \pbrac{x} &= \exp \pbrac{\sum_{n \geq 1} \frac{x^{n}}{n} \cdot \prod_{i \in \lambda^{n}} \widetilde{\cty{k}} \pbrac{\lambda^{i}} \pbrac{x^{i}}} \label{eq:ctyogf} \\
      \intertext{and}
      \widetilde{\ctxy{k}} \pbrac{\lambda} \pbrac{x} &= x \cdot \prod_{i \in \lambda} \widetilde{\cty{k}} \pbrac{\lambda^{i}} \pbrac{x^{i}} \label{eq:ctxyogf}
    \end{align}
  \end{subequations}
