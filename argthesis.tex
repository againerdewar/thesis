...
\begin{theorem}
  ...
  \begin{multline}
    ...
    \times Z_{\specname{E}} \circ \pbracs[Big]{p_{1} \sbrac{x} \cdot \prod_{c \in C \pbrac{\sigma}} \gci{\symgp{k}}{\cty{k}} \pbracs[Big]{\Delta^{-1} \prod_{i \in c} \rho_{i} \pbrac{\Delta \sigma}} \pbrac{p_{\abs{c}} \sbrac{x}, p_{2 \abs{c}} \sbrac{x}, \dots; p_{\abs{c}} \sbrac{y}, p_{2 \abs{c}} \sbrac{y}, \dots}}.
  \end{multline}
