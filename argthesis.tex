...
\begin{definition}\label{def:species} %TODO: Use Joyal's definition (functor to category of general sets with set maps) so that passage to quotient species is a natural transformation?
