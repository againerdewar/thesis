...
However, we note that, in the sense of Definition \ref{def:specdif}, since the species $\ktxy{k}$ embeds in the species $\ktx{k} + \kty{k}$ by the centering map in the proof of Theorem \ref{thm:dissymk}.
