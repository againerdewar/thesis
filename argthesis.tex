...
\begin{theorem}\label{thm:funcdecompct}
  ...
  \begin{subequations}
    ...
    \begin{align}
      ...
      \pointed[X]{\specname{CT}}_{k} &= X \cdot \specname{C}_{k+1} \pbrac{F_{k}} \label{eq:ctxfuncorig} \\
      \pointed[Y]{\specname{CT}}_{k} &= Y \cdot \specname{E} \pbrac{H_{k}} \label{eq:ctyfuncorig} \\
      \pointed[XY]{\specname{CT}}_{k} &= F_{k} \cdot
      H_{k}. \label{eq:ctxyfuncorig}
    \end{align}
  \end{subequations}
...
By equation \eqref{eq:ctxyfuncorig}, we can decompose a $\pointed[XY]{\specname{CT}}_{k}$-structure into an $F_{k}$-structure and an $H_{k}$-structure, each of which has a well-defined $\mathfrak{S}_{k}$-action, which we simply pass back up to $\pointed[XY]{\specname{CT}}_{k}$.
...
Thus, equation \eqref{eq:ffuncorig} holds in $\mathfrak{S}_{k}$-generality, and we conclude:
\begin{equation}
  \label{eq:ffuncci}
...
As in the previous section, the action of $\sigma \in \mathfrak{S}_{k}$ on the $\specname{E}$-structure in equation \eqref{eq:ctyfuncorig} is trivial, so again species composition is the desired operation:
\begin{equation}
  \label{eq:ayfunc}
