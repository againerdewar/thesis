...
\begin{theorem}
  ...
  \begin{align}
    \widetilde{\pointed[Y]{\specname{CT}}_{k}} \pbrac{\sigma} \pbrac{x} &= \tilde{\specname{E}} \pbrac{x \cdot \prod_{c \in C \pbrac{\sigma}} \widetilde{\pointed[Y]{\specname{CT}}_{k}} \pbrac{\prod_{i \in c} \rho_{i} \pbrac{\sigma}} \pbrac{x^{\abs{c}}}} \label{eq:ctyogf} \\
  ...
  \end{align}
  where $\tilde{\specname{E}} \pbrac{x} = \frac{1}{1 - x} = 1 + x + x^{2} + x^{3} + \dots$ is the ordinary generating function for sets.
\end{theorem}
