\documentclass[sectionflow,singlespace,twoside,draft]{brandiss} % Compactify for drafting (do *not* use these options for final submission!)
...
TODO: Restructure this section to begin with exposition and a definition.
...
TODO: Restructure this paragraph so it starts with a cycle, not an edge.
