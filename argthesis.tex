...
\begin{theorem}
  ...
  \begin{subequations}
    ...
    \begin{align}
      ...
      \ci{\pointed[XY]{\mathfrak{a}}_{k}} &= \qgci{\symgp{k}}{\pointed[XY]{\specname{CT}_{k}}} = \frac{1}{k!} \sum_{\sigma \in \symgp{k}} \gci{\symgp{k}}{\pointed[XY]{\specname{CT}}_{k}} \pbrac{\sigma} = \frac{1}{k!} \sum_{\sigma \in \symgp{k}} \pbrac{\gci{\symgp{k}}{F_{k}} \pbrac{\sigma} \cdot \gci{\symgp{k}}{H_{k}} \pbrac{\sigma}} \label{eq:axyquotci} \\
      \ci{\pointed[X]{\mathfrak{a}}_{k}} &= \qgci{\symgp{k} \rtimes C_{k+1}}{\pointed[XY]{\specname{CT}_{k}}} = \frac{1}{k! \pbrac{k+1}} \sum_{\substack{\sigma \in \symgp{k} \\ i \in \cbrac{0, 1, \dots, k}}} \gci{\symgp{k}}{\pointed[XY]{\specname{CT}}_{k}} \pbrac{\sigma, \zeta^{i}} \label{eq:axquotci}
    \end{align}
  \end{subequations}
\end{theorem}
...
\begin{theorem}[Cycle index for the species of $k$-trees]
  ...
  \end{multline}
\end{theorem}
TODO: Rewrite with bar notation?
