...
Since these actions are label-independent, we may now treat $\pointed[Y]{\specname{CT}}_{k}$ and $\pointed[\overline{XY}]{\specname{CT}}_{k}$ as $\symgp{k}$-species and $\pointed[\overline{XY}]{\specname{CT}}_{k}$ as a $\symgp{k+1}$-species.
