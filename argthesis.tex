...
\subsection{Quotients for $\pointed[Y]{\mathfrak{a}}_{k}$ and $\pointed[XY]{\mathfrak{a}}_{k}$}\label{ss:saction}
...
\subsection{Quotients for $\pointed[X]{\mathfrak{a}}_{k}$}\label{ss:zaction}
